...
from jombis.avatar.util import invalidate_cache
from jombis.avatar.settings import (AVATAR_STORAGE_DIR, AVATAR_RESIZE_METHOD,
...
def avatar_file_path(instance=None, filename=None, size=None, ext=None):
    ...
    tmppath.append(os.path.basename(md5_constructor(str(size)).hexdigest()+filename))
